...
<!-- ===============================================TULISAN JUDUL POJOK KIRI ATAS=============================================== -->
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
        ...
        <div class="sidebar-brand-text mx-3" style="font-size:0.8em;"> <?php echo "{$sidebarBrand} <br> @{$this->session->id}" ?> </div>
      </a>
...
<!-- ===============================================TAMBAH DATA=============================================== -->
      ...
      <!-- Nav Item - Add lapangan -->
      <li class="nav-item <?php if ($active == 'add_lapangan') { echo "active"; } ?>">
        <a class="nav-link" href=<?php echo base_url("{$tipeAkun}/add-lapangan") ?>>
          <i class="fas fa-fw fa-info-circle"></i>
          <span>Add Lapangan</span></a>
      </li>
...
<!-- ===============================================TAMPILKAN DATA=============================================== -->
      ...
      <li class="nav-item <?php if ($active == 'data_lapangan') { echo "active"; } ?>">
        <a class="nav-link" href=<?php echo base_url("{$tipeAkun}/data-lapangan") ?>>
          <i class="fas fa-fw fa-info-circle"></i>
          <span>Data Lapangan</span></a>
        </li>

      <!-- Nav Item - Data Provider -->
      <li class="nav-item <?php if ($active == 'data_booking') { echo "active"; } ?>">
        <a class="nav-link" href=<?php echo base_url("{$tipeAkun}/data-booking") ?>>
          <i class="fas fa-fw fa-info-circle"></i>
