<!--  -->
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <a href="<?php echo base_url("{$tipeAkun}/data-booking") ?>" style="text-decoration:none">
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Data Booking Lapang</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo "{$totProvider}" ?> Bookingan</div>
                    </div>
                    <div class="col-auto">
