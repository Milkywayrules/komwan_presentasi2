...
class CM_panel extends CI_Controller {
//
//
//
//  CP_panel = Controller Provider panel
//
//
//
//  ===============================================CONSTRUCT===============================================
...
//  ===============================================DETAIL DATA PROVIDER / MEMBER===============================================
	public function detail($from = '', $username ='')
	{
		...
		if ($from == 'data_provider') {
			$this->header2 = array(
				'tabTitle' 		=> 'Detail Provider - member',
...
//  ===============================================GENERATE REPORT===============================================
	...
	{
		$this->header2 = array(
			'tabTitle' 		=> 'Generate laporan - member',
